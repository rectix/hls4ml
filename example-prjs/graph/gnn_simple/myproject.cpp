...
#pragma HLS DATAFLOW
 ...
 if (!loaded_weights) {
   ...
   nnet::load_weights_from_txt<model_default_t, 12>(encoder_node_w0, "encoder_node_w0.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(encoder_node_b0, "encoder_node_b0.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(encoder_node_w1, "encoder_node_w1.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(encoder_node_b1, "encoder_node_b1.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(encoder_edge_w0, "encoder_edge_w0.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(encoder_edge_b0, "encoder_edge_b0.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(encoder_edge_w1, "encoder_edge_w1.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(encoder_edge_b1, "encoder_edge_b1.txt");
   nnet::load_weights_from_txt<model_default_t, 48>(core_edge_w0, "core_edge_w0.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(core_edge_b0, "core_edge_b0.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(core_edge_w1, "core_edge_w1.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(core_edge_b1, "core_edge_b1.txt");
   nnet::load_weights_from_txt<model_default_t, 32>(core_node_w0, "core_node_w0.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(core_node_b0, "core_node_b0.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(core_node_w1, "core_node_w1.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(core_node_b1, "core_node_b1.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(decoder_edge_w0, "decoder_edge_w0.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(decoder_edge_b0, "decoder_edge_b0.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(decoder_edge_w1, "decoder_edge_w1.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(decoder_edge_b1, "decoder_edge_b1.txt");
   nnet::load_weights_from_txt<model_default_t, 16>(decoder_edge_w2, "decoder_edge_w2.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(decoder_edge_b2, "decoder_edge_b2.txt");
   nnet::load_weights_from_txt<model_default_t, 4>(decoder_edge_w3, "decoder_edge_w3.txt");
