...
for i in range(1000): #90623
    if runCsim and not os.path.isfile('./tb_data_%i/tb_output_edge_predictions_%05d.dat'%(bit,i)):
        ...
        copyfile('/scratch/data/jduarte/exatrkx-neurips19/gnn-tracking/tb_data/tb_input_node_features_%05d.dat'%i, './tb_input_node_features.dat')
        copyfile('/scratch/data/jduarte/exatrkx-neurips19/gnn-tracking/tb_data/tb_output_edge_predictions_%05d.dat'%i, './tb_output_edge_predictions.dat')
        copyfile('/scratch/data/jduarte/exatrkx-neurips19/gnn-tracking/tb_data/tb_output_edge_targets_%05d.dat'%i, './tb_output_edge_targets.dat')
        copyfile('/scratch/data/jduarte/exatrkx-neurips19/gnn-tracking/tb_data/tb_receivers_%05d.dat'%i, './tb_receivers.dat')
        copyfile('/scratch/data/jduarte/exatrkx-neurips19/gnn-tracking/tb_data/tb_senders_%05d.dat'%i, './tb_senders.dat')
